...
export function BotnavTrial() {
  return (
    <>
      <Dock
        direction="middle"
        className="w-full border-2 flex max-md:gap-4 border-black"
      >
        {icons.map((icon) => (
          <DockIcon key={icon.name} className="max-md:mx-3">
            <div className="flex flex-col">
              <a href={icon.direct} className="w-full shrink-1">
                <icon.icon className="size-6 mx-auto" />
              </a>
